...
export function AdminProducts() {
  ...
  const updateMutation = useMutation({
    mutationFn: async () => {
      if (!editProduct) throw new Error("Produto invalido");
      ...
      if (editImageFile) {
        ...
        await fetch(`${apiBaseUrl}/api/products/${editProduct.id}/upload-image`, {
          method: "POST",
          headers: {
            "X-Tenant-Id": tenantId
          },
          ...
          <div key={product.id} className="rounded-2xl border border-brand-100 bg-white p-3">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500">{formatCurrencyNumber(Number(product.price))}</p>
              </div>
            </div>
            {product.imageUrl ? (
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setEditPrice(formatCurrencyNumber(Number(product.price)));
                  setEditImageFile(null);
        ...
        <Modal title="Detalhes do produto" onClose={() => setViewProduct(null)}>
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">{formatCurrencyNumber(Number(viewProduct.price))}</p>
            </div>
